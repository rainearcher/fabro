...
**Consensus merging** — a dedicated merge node combines the six audit reports and two critiques into a single truth. The merge rules are conservative: when in doubt, fail the checkbox.
